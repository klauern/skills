---
name: jira-pointing-grooming
description: Identify Jira tickets that still need clarification before pointing, summarize readiness gaps, and produce concrete grooming plans whenever the user asks to review or prep backlog work (especially FSEC).
---
